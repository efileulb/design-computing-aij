...
while len(pos) < core_num:
    ...
    if id not in pos:
        ...
        cpos_z=gh.ConstructPoint(ArrayPoint[id][0],ArrayPoint[id][1],ArrayPoint[id][2]+268990/2)
        core.append(gh.CenterBox(cpos_z,core_width/2,core_width/2,core_hight/2))

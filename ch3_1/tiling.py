...
def FJtile(n, c):
    ...
    turtle.penup()
    turtle.setheading(0)
    turtle.left(n * 90); turtle.forward(37.5 * scale)
    turtle.left(90); turtle.forward(7.5 * scale)
    turtle.pendown()
    turtle.color("#e8e2cc")
    turtle.begin_fill(); turtle.forward(30.0 * scale)
    turtle.left(90); turtle.forward(75.0 * scale)
    turtle.left(90); turtle.forward(75.0 * scale)
    turtle.left(90); turtle.forward(30.0 * scale)
    ...
    turtle.right(90); turtle.forward(32.0 * scale)
    turtle.end_fill()
    if c % 2 == 0:
        turtle.color("#5775b1")
    else:
